...
class _MyProfileState extends State<MyProfile> {
  String token;
  var data = UserProfile(username: "Bob",balance: 100,email: "bob@gmail.com");
  int touchedIndex=-1;
                  ...
                  SizedBox(height: 0.001 * height,),
                         ListView(
                            ...
                            children: [
                              ...
                              Center(child: Text(data.username,style: paraText.copyWith(fontWeight: FontWeight.w600,color: Colors.black,fontSize: 35),)),
                              Center(child: Text(data.email,style: paraText.copyWith(fontWeight: FontWeight.w500,color: Color(0xff979797),fontSize: 18))),
