            ...
            children: [
              Expanded(
                child: TextFormField(
                  ...
                  focusNode: widget.privacy==2?new AlwaysDisabledFocusNode():null,
                ),
              ),
              widget.privacy==1?IconButton(
                  onPressed: (){
                    toggle();
                  },
                  icon: Icon(hide?FontAwesomeIcons.lock:FontAwesomeIcons.unlock)):Container(),
